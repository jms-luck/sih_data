...
import 'cuztomize_widget.dart' show CuztomizeWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class CuztomizeModel extends FlutterFlowModel<CuztomizeWidget> {
  ...
  String? _fullNameTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'x06zao38' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '870rbk0a' /* Please enter an age for the pa... */,
      );
    }
  ...
  String? _dateOfBirthTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'i9g2obmy' /* Please enter the date of birth... */,
      );
    }
