...
import 'cuztomize_model.dart';
export 'cuztomize_model.dart';

class CuztomizeWidget extends StatefulWidget {
  const CuztomizeWidget({super.key});

  @override
  State<CuztomizeWidget> createState() => _CuztomizeWidgetState();
}

class _CuztomizeWidgetState extends State<CuztomizeWidget> {
  late CuztomizeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CuztomizeModel());
            ...
            children: [
              Text(
                FFLocalizations.of(context).getText(
                  '562t70z4' /* Contract Customization */,
                ),
              ...
              Text(
                FFLocalizations.of(context).getText(
                  'kd19bz9o' /* Please fill out the form below... */,
                ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: [
                                      FFLocalizations.of(context).getText(
                                        '5fibsdwx' /* Insurance Provider 1 */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'mrnjiyer' /* Insurance Provider 2 */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'c3qah1rj' /* Insurance Provider 3 */,
                                      )
                                    ],
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        '8vgplzky' /* Please describe your symptoms.... */,
                                      ),
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
